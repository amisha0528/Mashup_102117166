...
def main():
    st.title("Music Mashup Generator - Amisha - 102117166")
    ...
    if st.button("Generate Mashup"):
        ...
        if create_music_mashup('AIzaSyAzrMmAAgGJygxEkBI96aGVLTekpB_LkcY', artist_name, num_videos, audio_duration, output_filename):
            ...
            st.success("Please do check in your spam folder. It will be from mail id : noreply.amishakansal1234@gmail.com")
        else:
